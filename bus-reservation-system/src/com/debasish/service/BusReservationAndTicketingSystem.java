 ...
 * @description This is a project where we will read three files i.e., bus_destination.txt, bus_fare.txt & Data.txt.
 * 				and we can authenticate user through username = 1, password = 1. Select the destinations and passengers by entering your choices.
					...
					for (x = 1; x == 1;) {
						...
						// if CHOICE is "2" proceed to Ticket Booking//
							...
							// inputing of Passenger's Name//
								...
								FileReader fr = new FileReader("bus_destination.txt");
								...
								FileReader fr1 = new FileReader("bus_fare.txt");
								BufferedReader br1 = new BufferedReader(fr1);
								double[] fare = new double[6];

								for (int k = 0; k < fare.length; k++) {
									fare[k] = Double.parseDouble(br1.readLine());
								}
